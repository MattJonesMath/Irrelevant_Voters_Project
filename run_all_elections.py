...
which_methods = [run_scottish, run_adapt_quota, run_meek, run_cham_cour_OM, run_cham_cour_PM, run_greedy_cham_cour, run_expand_app, run_cpo_stv, run_expand_app_om]
headers = ['Scottish STV Winners', 'Adaptive Quota STV Winners', 'Meek STV Winners', 'Chamberlin-Courant (OM) Winners', 'Chamberlin-Courant (PM) Winners', 'Greedy Chamberlin-Courant Winners', 'Expanding Approvals Winners', 'CPO-STV Winners', 'Expanding Approvals OM Winners']
...
for election_num, name in enumerate(file_names):
    ...
    method_functions = [election.scot_stv, election.aq_stv, election.meek_stv, election.cham_cour, election.cham_cour, election.greedy_cham_cour, election.expanding_approvals, election.cpo_stv, election.expanding_approvals_om]
